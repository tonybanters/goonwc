...
VIEWPORTER_XML = lib/owl/protocols/viewporter.xml
...
$(TARGET): $(PROTOCOL_H) $(PROTOCOL_C) $(LAYER_SHELL_H) $(LAYER_SHELL_C) $(XDG_OUTPUT_H) $(XDG_OUTPUT_C) $(EXT_WORKSPACE_H) $(EXT_WORKSPACE_C) $(XDG_DECORATION_H) $(XDG_DECORATION_C) $(SCREENCOPY_H) $(SCREENCOPY_C) $(PRIMARY_SEL_H) $(PRIMARY_SEL_C) $(LINUX_DMABUF_H) $(LINUX_DMABUF_C) $(VIEWPORTER_H) $(VIEWPORTER_C) $(OBJ)
	$(CC) $(OBJ) -o $@ $(LDFLAGS)
...
$(VIEWPORTER_H): $(VIEWPORTER_XML) | build
	wayland-scanner server-header $< $@

$(VIEWPORTER_C): $(VIEWPORTER_XML) | build
	wayland-scanner private-code $< $@

%.o: %.c $(PROTOCOL_H) $(PROTOCOL_C) $(LAYER_SHELL_H) $(LAYER_SHELL_C) $(XDG_OUTPUT_H) $(XDG_OUTPUT_C) $(EXT_WORKSPACE_H) $(EXT_WORKSPACE_C) $(XDG_DECORATION_H) $(XDG_DECORATION_C) $(SCREENCOPY_H) $(SCREENCOPY_C) $(PRIMARY_SEL_H) $(PRIMARY_SEL_C) $(LINUX_DMABUF_H) $(LINUX_DMABUF_C) $(VIEWPORTER_H) $(VIEWPORTER_C)
	$(CC) $(CFLAGS) -c $< -o $@
